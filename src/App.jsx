    ...
    <div className="app">
      <Box width="100%" backgroundColor="rgba(5, 32, 64, 28)">
        ...
        >
          ...
          {account ? (
            <Box backgroundColor="#000" padding="15px" borderRadius="6px">Connected</Box>
          ) : (<Button onClick={signIn} color="rgba(5, 32, 64)" _hover={{backgroundColor: "#808080"}}>Connect</Button>)}
        </Box>
      </Box>
        ...
        <Box width="65%" maxWidth="65%" minWidth="65%">
          {posts.map((post) => (
            ...
            >
              <Box display="flex">
                {/* PROFILE IMAGE */}
                <Box width="75px" height="75px" marginTop="8px"></Box>
                  <img 
                    alt="profile"
